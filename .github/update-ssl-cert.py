"""
    ...
    - 多吉云 (已注释): https://console.dogecloud.com/cdn/cert
...
# https://github.com/mycpen/blog/blob/main/.github/refresh-dogecloud.py
...
# if api['code'] == 200:
#     # print(api['data']['id'])
#     main_cert_id = api['data']['id']
#     # 为加速域名绑定证书
#     api = dogecloud_api('/cdn/domain/config.json?domain=blog.cpen.top', {'cert_id': api['data']['id']}, True)
# 	# api['code'] == 200 则成功，否则失败，失败请参考 api['msg'] 判断
# else:
#     print("api failed: " + api['msg']) # 失败

# # 删除无用证书
# api = dogecloud_api('/cdn/cert/list.json')	# 获取证书列表
# if api['code'] == 200:
#     for cert in api['data']['certs']:
#         # print(cert)   # 获取证书列表
#         if cert['id'] != main_cert_id:
#             # 删除证书
#             api = dogecloud_api('/cdn/cert/delete.json', {'id': cert['id']})
# else:
#     print("api failed: " + api['msg']) # 失败
