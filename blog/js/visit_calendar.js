var visit_calendar = (site_id, access_token, metrics, visit_color) => {
    ...
    var visit_apiurl = 'https://bd-tongji.cpen.top/api?site_id=' + site_id + '&access_token=' + access_token + '&method=overview/getTimeTrendRpt' + '&metrics=' + metrics + '&start_date=' + start_date + '&end_date=' + end_date;
  ...
  (function init () {
    ...
    visit_calendar('18367057', '', 'pv_count', visit_color)
  })()
